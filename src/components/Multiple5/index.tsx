        ...
        <Alternatives>
           ...
           }
           {
               question.question.image_d_url && question.question.answer_d ? (
                ...
                onClick={(e)=>handleAnswer(e)}
                style={ selectedAnswer === question.question.answer_d || selectedAnswer === '' ? {backgroundImage: `url(${question.question.image_d_url})`, 
                    backgroundRepeat: 'no-repeat',  backgroundSize: '100% 100%'} : 
           ...
           }
           {
               question.question.image_e_url && question.question.answer_e ? (
                ...
                onClick={(e)=>handleAnswer(e)}
                style={ selectedAnswer === question.question.answer_e || selectedAnswer === '' ? {backgroundImage: `url(${question.question.image_e_url})`, 
                    backgroundRepeat: 'no-repeat',  backgroundSize: '100% 100%'} : 
